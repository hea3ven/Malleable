...
group = "com.hea3ven.malleable"
version = "$project_version-$buildNo"

base {
	archivesBaseName = "malleable"
}
...
dependencies {
    ...
    modCompile("com.hea3ven.tools.commonutils:h3nt-commonutils:3.0.0-fabric-4")
    shadow("com.hea3ven.tools.commonutils:h3nt-commonutils:3.0.0-fabric-4")
